...
public class MainGUIApp extends JFrame implements Runnable {
...
private MoveAndActionPiece manager;
	...
	private void init() {
		...
		dashboard = new GameDisplayApp(map, manager, set, setP2, setIA);
