...
public class PaintPlateau {
	...
	public void paint(Marechal marechal, Graphics graphics) {
		...
		if(marechal.getNom()=="Marechal" && marechal.getPlayer() == 1) {
			graphics.drawImage(ReadImage.readImage("src/images/m.png"), x * blockSize, y * blockSize, blockSize, blockSize, null);
		}
		else {
			graphics.drawImage(ReadImage.readImage("src/images/player2.jpg"), x * blockSize, y * blockSize, blockSize, blockSize, null);
	...
	public void paint(General general, Graphics graphics) {
		...
		int y = position.getLignes();
		int x = position.getColomnes();
		if(general.getNom().equalsIgnoreCase("General") && general.getPlayer() == 1) {
	...
	public void paint(Drapeau drapeau, Graphics graphics) {
		...
		int y = position.getLignes();
		int x = position.getColomnes();
		if(drapeau.getNom().equalsIgnoreCase("Drapeau") && drapeau.getPlayer() == 1) {
	...
	public void paint(MinesTerrestres mines, Graphics graphics) {
		...
		int y = position.getLignes();
		int x = position.getColomnes();
		if(mines.getNom().equalsIgnoreCase("Mine") && mines.getPlayer() ==1) {
	...
	public void paint(GenerauxDeDivision gdd, Graphics graphics) {
		...
		int y = position.getLignes();
		int x = position.getColomnes();
		if(gdd.getNom().equalsIgnoreCase("GDD") && gdd.getPlayer() == 1) {
	...
	public void paint(Brigadier brigadier, Graphics graphics) {
		...
		int y = position.getLignes();
		int x = position.getColomnes();
		if(brigadier.getNom().equalsIgnoreCase("Brigadier") && brigadier.getPlayer() == 1) {
	...
	public void paint(Colonel colonel, Graphics graphics) {
		...
		int y = position.getLignes();
		int x = position.getColomnes();
		if(colonel.getNom().equalsIgnoreCase("Colonel") && colonel.getPlayer() == 1) {
	...
	public void paint(Commandant commandant, Graphics graphics) {
		...
		int y = position.getLignes();
		int x = position.getColomnes();
		if(commandant.getNom().equalsIgnoreCase("Commandant") && commandant.getPlayer() == 1) {
	...
	public void paint(Capitaine capitaine, Graphics graphics) {
		...
		int y = position.getLignes();
		int x = position.getColomnes();
		if(capitaine.getNom().equalsIgnoreCase("Capitaine") && capitaine.getPlayer() == 1) {
	...
	public void paint(Lieutenant lieutenant, Graphics graphics) {
		...
		int y = position.getLignes();
		int x = position.getColomnes();
		if(lieutenant.getNom().equalsIgnoreCase("lieutenant") && lieutenant.getPlayer() == 1) {
	...
	public void paint(Ingenieur ingenieur, Graphics graphics) {
		...
		int y = position.getLignes();
		int x = position.getColomnes();
		if(ingenieur.getNom().equalsIgnoreCase("ingenieur") && ingenieur.getPlayer() == 1) {
	...
	public void paint(Bombe bomb, Graphics graphics) {
		...
		int y = position.getLignes();
		int x = position.getColomnes();
		if(bomb.getNom().equalsIgnoreCase("Bombe") && bomb.getPlayer() == 1) {
