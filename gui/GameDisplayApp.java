...
public class GameDisplayApp extends JPanel{
	private SetMapP1 set;
	private SetMapP2 setP2;
	private SetPionsIA setIA;
	private Plateau plateau;
	private MoveAndActionPiece manager;
	private PaintPlateauApp paintPlateau = new PaintPlateauApp();
	public GameDisplayApp(Plateau p, MoveAndActionPiece manager, SetMapP1 set, SetMapP2 setP2, SetPionsIA setIA ) {
		this.plateau=p;
